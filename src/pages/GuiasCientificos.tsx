        ...
        <div className="grid gap-4 sm:grid-cols-1 lg:grid-cols-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Compostos e fontes naturais</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-muted-foreground mb-4">
                Guia completo sobre alimentos ricos em antioxidantes e seus
                benefícios para prevenção de doenças crônicas.
              </p>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground mb-4">
                Estrutura alimentar para reduzir marcadores inflamatórios e
