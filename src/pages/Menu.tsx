...
export default function Menu() {
	...
	const isPremiumUser = ["TRANSFORMACAO", "Transformação"].includes(currentUser.plan);
					...
					<DropdownMenu>
						<DropdownMenuTrigger asChild>
							...
							>
								...
								Compartilhar
								{!canShareOrDownload && <Crown className="h-3 w-3 text-amber-500 shrink-0" />}
							</Button>
						</DropdownMenuTrigger>
						{canShareOrDownload && (
