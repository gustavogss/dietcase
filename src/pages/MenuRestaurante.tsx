    ...
    setTimeout(() => {
      ...
      if (hasHypertension || hasDiabetes) {
        ...
        setAnalysisResult({
          ...
          feedback:
            "Excelente escolha! Esta refeição está bem equilibrada, rica em nutrientes e totalmente de acordo com seu perfil metabólico.",
          substitutions: [],
        });
      }
    }, 3000);
      ...
      <div className="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 py-4 sm:py-6 space-y-6">
        <div className="text-center sm:text-left">
          ...
          <p className="text-muted-foreground mt-2">
            Use a câmera ou envie uma foto do seu prato para a IA analisar se
            ele é seguro e ideal para você.
          </p>
        </div>
        ...
        <div className="grid gap-6 md:max-w-3xl mx-auto">
          ...
          <Card
            className={`flex flex-col transition-opacity duration-500 max-h-min ${!analysisResult ? "opacity-50 pointer-events-none" : "opacity-100"}`}
          >
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
              ...
              {analysisResult && (
                <div className="space-y-6 animate-in fade-in zoom-in duration-300">
                  ...
                  >
                    ...
                    <div>
                      <h3
                        className={`font-semibold ${analysisResult.isIdeal ? "text-green-800 dark:text-green-400" : "text-red-800 dark:text-red-400"}`}
                      >
                        {analysisResult.isIdeal
                          ? "Refeição Liberada!"
                          : "Atenção Necessária"}
                      ...
                      <p
                        className={`text-sm mt-1 leading-relaxed ${analysisResult.isIdeal ? "text-green-700 dark:text-green-300" : "text-red-700 dark:text-red-300"}`}
                      >
                      ...
                      <div className="space-y-3">
                        ...
                        <ul className="space-y-2">
                          {analysisResult.substitutions.map((sub, idx) => (
                            <li
                              key={idx}
                              className="text-sm bg-muted/50 p-3 rounded-md border-l-2 border-l-primary flex gap-2"
                            >
